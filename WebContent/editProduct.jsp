	...
	<div align="center">
		<form action="processEditProduct.jsp" method="post">
			<table class="productTable">
				...
				<tr>
					<td>Usability</td>
					<td><input type="text" name="prodUsability" size="20"
						value="<%=product.getProductUsability()%>" class="productTextField"/></td>
				</tr>
				<tr>
					<td>Quantity</td>
					<td><input type="text" name="prodQuantity" size="20"
						value="<%=product.getProductQuantity()%>" class="productTextField"/></td>
				</tr>
				<tr>
					<td>Color</td>
					<td><input type="text" name="prodColor" size="20"
						value="<%=product.getProductColor()%>" class="productTextField"/></td>
				</tr>
				<tr>
					<td>Status</td>
					<td><input type="text" name="prodStatus" size="20"
						value="<%=product.getProductStatus()%>" class="productTextField"/></td>
				</tr>
			</table>
